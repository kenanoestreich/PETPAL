...
from ..preproc.register import register_pet, warp_pet_to_atlas, warp_segmentation_to_atlas
...
class ImageToImageStep(FunctionBasedStep):
    ...
    @classmethod
    def default_warp_segmentation_to_atlas(cls, name: str = 'warp_seg_to_atlas', anat_image_path: str = '',
                                  atlas_image_path: str = '', **overrides):
        """Creates a default step instance for warping a segmentation image to an atlas using :func:`~petpal.preproc.register.warp_segmentation_to_atlas`.
        ...
        Args:
            name (str): Name of the step. Defaults to 'warp_seg_to_atlas'.
            anat_image_path (str): Path to anatomical image used to compute transform to atlas space. Defaults to an
                empty string ''.
            atlas_image_path (str): Path to atlas image to which segmentation will be warped
                (indirectly, via the anatomical image).
            **overrides: Override default parameters

        Returns:
            :class:`~petpal.pipelines.preproc_steps.ImageToImageStep`:
                A new step instance for warping the segmentation image to atlas space.
        """
